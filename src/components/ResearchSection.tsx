    ...
    <section id="latest-research" className="scroll-mt-24 bg-white py-8 sm:py-10 md:py-12 lg:py-14 xl:py-16">
      <div className="page-shell mx-auto">
        ...
        <div className="mb-2 flex items-center justify-center gap-2 sm:gap-3">
          ...
          <p className="whitespace-nowrap font-serif font-bold text-navy
        ...
        {/* HEADING */}
        <h2 className="
          mb-2 text-center font-bold tracking-tight
        ...
        {/* SUBTEXT */}
        <p className="
          mx-auto mb-6 text-center text-muted-foreground
          text-[14px] sm:text-[16px] md:text-[18px] lg:text-[18px] xl:text-[20px]
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 lg:auto-rows-fr">
          ...
          <div className="group flex h-full flex-col overflow-hidden rounded-2xl bg-white shadow-md hover:bg-[#0A1F44]">
            ...
            <img
              ...
              h-[200px] sm:h-[220px] md:h-[200px] lg:h-[220px] xl:h-[240px]"
            />

            <div className="p-4 text-left">

              <span className="rounded-full bg-gradient-to-r from-[#0A0E33] to-[#25A6DD]
              px-2 py-[2px] text-[11px] sm:text-[12px] text-white">
                AI / IA
              </span>

              <h3 className="
              mt-1 font-semibold
              text-[20px] sm:text-[22px] md:text-[22px] lg:text-[20px] xl:text-[22px]
              ...
              <p className="
              mt-1 text-gray-500 group-hover:text-white/80
              text-[14px] sm:text-[15px] md:text-[16px] lg:text-[14px]
              ">
              ...
              <div className="mt-2 flex items-center justify-between">
                <p className="
                font-bold text-gray-600 group-hover:text-white/80
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* CHIPSET CARD (HEIGHT REDUCED) */}
            <div className="relative overflow-hidden rounded-2xl shadow-md
            h-[160px] sm:h-[180px] md:h-[180px] lg:h-[190px] xl:h-[200px]">
              ...
              <div className="absolute inset-0 flex flex-col bg-black/60 p-4">
                ...
                <span className="w-fit rounded-full bg-gradient-to-r from-[#0A0E33] to-[#25A6DD]
                px-2 py-[2px] text-[11px] sm:text-[12px] text-white">
                  Chipset
                </span>
                ...
                text-[18px] sm:text-[20px] md:text-[20px] lg:text-[18px] xl:text-[20px]
                ">
                ...
                <p className="
                mt-1 text-white/80
                text-[13px] sm:text-[14px] md:text-[15px] lg:text-[13px]
                ">
            ...
            <div className="group flex flex-col overflow-hidden rounded-2xl bg-white shadow-md hover:bg-[#0A1F44]">
              ...
              <div className="p-4 text-left">
                ...
                <h4 className="
                mt-1 font-semibold group-hover:text-white
                text-[20px] sm:text-[22px] md:text-[22px] lg:text-[20px]
                ">
